...
namespace DataStructures.Test
{
    public static class BinarySearchTreeTests
    {
        ...
        public static void Constructor_UseCustomComparer_FormsCorrectTree()
        {
            ...
            Assert.AreEqual("bbbb", tree.Search("vvv")!.Right!.Data);
        }
        ...
        public static void Add_MultipleKeys_FormsCorrectBST()
        {
            ...
            Assert.AreEqual(3, threeNode!.Data);
            Assert.AreEqual(2, threeNode!.Left!.Data);
            Assert.AreEqual(4, threeNode!.Right!.Data);
        ...
        public static void Search_MultipleKeys_FindsAllKeys()
        {
            ...
            Assert.AreEqual(2, tree.Search(2)!.Data);
            Assert.AreEqual(3, tree.Search(3)!.Data);
            Assert.AreEqual(4, tree.Search(4)!.Data);
            Assert.AreEqual(5, tree.Search(5)!.Data);
            Assert.AreEqual(6, tree.Search(6)!.Data);
            Assert.AreEqual(7, tree.Search(7)!.Data);
            Assert.AreEqual(8, tree.Search(8)!.Data);
        }
        ...
        public static void GetMax_NonEmptyTree_ReturnsCorrectValue()
        {
            ...
            Assert.AreEqual(8, tree.GetMax()!.Data);
        }
        ...
        public static void GetMin_NonEmptyTree_ReturnsCorrectValue()
        {
            ...
            Assert.AreEqual(2, tree.GetMin()!.Data);
        }
